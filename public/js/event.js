    ...
    if (data.length) {
      for (var x = 0; x < data.length; x++) {
        ...
        divmain.setAttribute(
          "class",
          "single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp"
        );
        divsub1.setAttribute(
          "class",
          "single-schedule-tumb-info d-flex align-items-center"
        );
